...
3. Then deploy with `clarifai model deploy` (see `clarifai-deployment-lifecycle`) or route to `clarifai-inference` for inference
...
3. Deploy: `clarifai model deploy ./orchestrator`
