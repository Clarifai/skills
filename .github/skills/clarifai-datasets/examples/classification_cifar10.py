# Classification DataLoader - CSV-based (Cifar10 style)
# Source: github.com/Clarifai/examples/datasets/upload/image_classification/cifar10/dataset.py
#
# Data structure:
#   cifar10/
#   ├── dataset.py (this file)
#   ├── cifar_small_train.csv
#   └── images/
#       └── *.jpg
...
class Cifar10DataLoader(ClarifaiDataLoader):
    """Cifar10 Dataset - CSV-based image classification."""
